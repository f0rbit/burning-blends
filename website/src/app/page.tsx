    ...
    <>
      ...
      <header className="flex items-center py-8 flex-col gap-4">
        ...
        <p
          ...
          style={{ maxWidth: "min(23.5rem, 80vw)" }}
        >
          I&apos;m on a mission to find the best cafés in Adelaide. I also
          review music from time-to-time (and paint some of the album covers)
        </p>
        <br />
      </header>
